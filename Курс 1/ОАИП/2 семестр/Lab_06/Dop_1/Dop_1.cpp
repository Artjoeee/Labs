...
void searchAndPrintPrev(Node* head, char value);
...
int main()
{
    ...
    while (choice != 0)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            cout << "Введите символ для поиска и вывода предыдущего: ";
            cin >> value;

            searchAndPrintPrev(head, value);  // Вызов функции для поиска и печати предыдущего элемента
            break;
        case 4:
...
// Функция для поиска и печати предыдущего элемента списка
void searchAndPrintPrev(Node* head, char value)
{
    Node* current = head;

    if (current == nullptr || current->data == value) {
        cout << "Символ не найден или предыдущего символа нет" << endl;
        return;
    }
    ...
    while (current->next != nullptr)
    {
        ...
        {
            cout << "Найденный символ: " << current->next->data << ", Предыдущий символ: " << current->data << endl;
            return;
        }
...
void toFile(Node* head)
{
    ...
    if (file.is_open())
    {
        ...
        cout << "Список записан в файл word.txt" << endl;
    }
    else
    {
...
void fromFile(Node*& head)
{
    ...
    if (file.is_open())
    {
        ...
        cout << "Список считан из файла word.txt" << endl;
    }
    else
    {
        cout << "Ошибка открытия файла" << endl;
...
void menu()
{
    ...
    cout << "3 - Поиск и вывод предыдущего элемента" << endl;
