...
int main()
{
    ...
    while (choice != 0)
    {
        ...
        case 2:
            ...
            break;
        case 3:
            multi10(head);  // Вызов функции для подсчета произведения элементов, меньших 10
            break;
        case 4:
...
void toFile(Node* head)
{
    ...
    if (file.is_open())
    {
        ...
        cout << "Список записан в файл count.txt" << endl;
    }
    else
    {
...
void fromFile(Node*& head)
{
    ...
    if (file.is_open())
    {
        ...
        cout << "Список считан из файла count.txt" << endl;
    }
    else
    {
        cout << "Ошибка открытия файла" << endl;
...
// Функция нахождения произведения элементов, меньших 10
void multi10(Node* head)
{
    float multi = 1;
    Node* current = head;
    ...
    while (current != nullptr)
    {
        ...
        {
            multi *= current->number;
        }

        current = current->next;
    }

    cout << "Произведение элементов, меньших 10: " << multi << endl;
}
...
void menu()
{
    ...
    cout << "3 - Найти произведение элементов, меньших 10" << endl;
