...
double func1(double x) // Определение функции уравнения x^3 + 3x - 1
{
    return pow(x, 3) + 3 * x - 1;
}

double func2(double x) // Определение функции уравнения e^x - 4
{
    return exp(x) - 4;
}
...
int main()
{
    ...
    cout << "Введите интервалы для уравнения x^3 + 3x - 1 (a, b): ";

    cin >> a1 >> b1;

    cout << "Введите интервалы для уравнения e^x - 4 (a, b): ";

    cin >> a2 >> b2;

    r1 = dychotomy(func1, a1, b1, e); // Находим корень для уравнения x^3 + 3x - 1

    cout << "Корень уравнения x^3 + 3x - 1: " << r1 << endl;

    r2 = dychotomy(func2, a2, b2, e);  // Находим корень для уравнения e^x - 4

    cout << "Корень уравнения e^x - 4: " << r2 << endl;
