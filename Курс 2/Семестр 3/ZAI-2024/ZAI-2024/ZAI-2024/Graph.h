...
#define FST_CHARLIT 4, \
    ...
    FST::NODE(340, \
        ...
        FST::RELATION(':', 2), FST::RELATION('-', 2), FST::RELATION(')', 2), FST::RELATION('(', 2), FST::RELATION('_', 2), FST::RELATION('=', 2), \
        FST::RELATION('*', 2), FST::RELATION('/', 2), FST::RELATION('+', 2), FST::RELATION('-', 2), FST::RELATION('%', 2), FST::RELATION('>', 2), FST::RELATION('<', 2),\
        \
        ...
        FST::RELATION('ý', 2), FST::RELATION('þ', 2), FST::RELATION('ÿ', 2), \
        \
        FST::RELATION('À', 2), FST::RELATION('Á', 2), FST::RELATION('Â', 2), FST::RELATION('Ã', 2), FST::RELATION('Ä', 2), FST::RELATION('Å', 2), \
        FST::RELATION('¨', 2), FST::RELATION('Æ', 2), FST::RELATION('Ç', 2), FST::RELATION('È', 2), FST::RELATION('É', 2), FST::RELATION('Ê', 2), \
        FST::RELATION('Ë', 2), FST::RELATION('Ì', 2), FST::RELATION('Í', 2), FST::RELATION('Î', 2), FST::RELATION('Ï', 2), FST::RELATION('Ð', 2), \
...
#define FST_BINARYLIT 11, \
    FST::NODE(1, FST::RELATION('0', 1)), \
    FST::NODE(2, FST::RELATION('b', 2), FST::RELATION('B', 2)), \
    FST::NODE(2, FST::RELATION('0', 3), FST::RELATION('1', 3)), \
    FST::NODE(2, FST::RELATION('0', 4), FST::RELATION('1', 4)), \
    FST::NODE(2, FST::RELATION('0', 5), FST::RELATION('1', 5)), \
    FST::NODE(2, FST::RELATION('0', 6), FST::RELATION('1', 6)), \
    FST::NODE(2, FST::RELATION('0', 7), FST::RELATION('1', 7)), \
    FST::NODE(2, FST::RELATION('0', 8), FST::RELATION('1', 8)), \
    FST::NODE(2, FST::RELATION('0', 9), FST::RELATION('1', 9)), \
	FST::NODE(2, FST::RELATION('0', 10), FST::RELATION('1', 10)), \
    FST::NODE()
