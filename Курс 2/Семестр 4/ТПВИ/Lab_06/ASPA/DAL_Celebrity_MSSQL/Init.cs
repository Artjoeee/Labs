...
namespace DAL_Celebrity_MSSQL
{
    public class Init
    {
        static string connstring = @"Server=(localdb)\mssqllocaldb; Database=CELEBRITIES; Trusted_Connection=True;";
        public Init() { }
        ...
        public static void Execute(bool delete = true, bool create = true)
        {
            ...
            { //5
                ...
                LifeEvent l2 = new LifeEvent()
                {
                    ...
                    Description = "Выложил исходный код OS Linux (версии 0.01)",
                    ReqPhotoPath = null
                };
                context.Celebrities.Add(c);
                context.LifeEvents.Add(l1);
            ...
            { //10
                ...
                LifeEvent l2 = new LifeEvent()
                {
                    ...
                    Description = "Создал OS MINIX - бесплатную Unix-подобную систему",
                    ReqPhotoPath = null
                };
                context.Celebrities.Add(c);
                context.LifeEvents.Add(l1);
