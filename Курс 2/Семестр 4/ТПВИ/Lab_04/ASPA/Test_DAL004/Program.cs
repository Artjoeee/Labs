...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        using (IRepository repository = Repository.Create("Celebrities"))
        {
            ...
            if (testupd1 != null)
            {
                if (repository.updCelebrityById((int)testupd1, new Celebrity(0, "Updated1", "Update1", "Photo/Updated1.jpg")))
                {
            ...
            if (testupd2 != null)
            {
                if (repository.updCelebrityById((int)testupd2, new Celebrity(0, "Updated2", "Update2", "Photo/Updated2.jpg")))
                {
            ...
            if (repository.updCelebrityById(1000, new Celebrity(0, "Updated1000", "Update1000", "Photo/Updated1000.jpg")))
            {
