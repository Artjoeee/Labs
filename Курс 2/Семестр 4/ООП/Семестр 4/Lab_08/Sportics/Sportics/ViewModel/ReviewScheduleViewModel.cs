...
namespace Sportics.ViewModel
{
    public class ReviewScheduleViewModel : BaseViewModel
    {
        ...
        private void SubmitReview()
        {
            ...
            SessionReviewRepository.SaveSessionReview(review);
        ...
        private void SubmitAdminReply()
        {
            ...
            bool success = SessionReviewRepository.SaveAdminReply(SelectedReview.Id, AdminReplyText);
        ...
        private void DeleteSelectedReview()
        {
            ...
            bool success = SessionReviewRepository.DeleteSessionReview(SelectedReview.Id);
            if (success)
            {
        ...
        {
            var reviews = SessionReviewRepository.LoadSessionReviews()
