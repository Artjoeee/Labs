...
namespace Sportics.ViewModel
{
    ...
    {
        public Membership CreatedMembership { get; private set; }
        ...
        private void ExecuteAdd()
        {
            ...
            // Здесь один вызов, который вернет объект с Id
            CreatedMembership = DataWorker.AddMembership(
                FullName,
                ShortName,
                Category,
                Description,
